...
const RenderQA = () => {
  ...
  const qaData = [
    { q: "What is the dress code?", a: config.dressCode },
    ...
    { q: "What time should I arrive to the church?", a: `The ceremony begins promptly at ${config.qa.ceremonyStartTime}. We recommend arriving 15-20 minutes early to find your seat.` },
    { q: "What is the distance between the venues?", a: `The distance from the ceremony to the reception is ${config.qa.venueDistance} and will take ${config.qa.venueTravelTime} to get there so please plan accordingly.` },
    { q: "Are the events indoors or outddors?", a: "Both the ceremony and reception will be indoors." },
    { q: "Is there a cocktail hour?", a: `Yes! Cocktail hour begins at ${config.qa.cocktailHourTime} followed by dinner and dancing at ${config.qa.dinnerTime}.` }
  ];
