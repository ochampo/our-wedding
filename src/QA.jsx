...
const RenderQA = () => {
  ...
  const qaData = [
    ...
    { q: "Distance between venues?", a: "The distance from the ceremony to the reception is around 25 miles and will take 30 to 45 minutes so please plan accordingly." },
    { q: "Indoors or outdoors?", a: "Both the ceremony and reception will be indoors." },
    ...
    <main className="relative min-h-screen w-full bg-slate-50">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 pb-40 animate-in fade-in duration-700">
        ...
        <div className="text-center mb-12">
            ...
            <h2 className="text-5xl md:text-6xl text-center text-purple-900 mb-8 font-serif italic" style={textGlow}>
                Q & A
            </h2>
        </div>
